...
public class bowl_ining4_Adapter extends BaseAdapter {
    bat_bowl_ining_4 main;

    bowl_ining4_Adapter(bat_bowl_ining_4 main) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        bowl_ining4_Adapter.ViewHolderItem holder = new bowl_ining4_Adapter.ViewHolderItem();
        if (convertView == null) {
            ...
            holder = (bowl_ining4_Adapter.ViewHolderItem) convertView.getTag();
        }
