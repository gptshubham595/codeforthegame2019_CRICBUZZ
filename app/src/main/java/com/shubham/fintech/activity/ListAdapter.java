...
public class ListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.srs_dot = (TextView) convertView.findViewById(R.id.srs_dot);
        ...
        Picasso.get().load(holder.flag_url1).into(holder.flag1);
        Picasso.get().load(holder.flag_url2).into(holder.flag2);
        holder.srs_str = this.main.live_data_list.get(position).srs;
        holder.overs.setText(this.main.live_data_list.get(position).overs+"Ovs");
