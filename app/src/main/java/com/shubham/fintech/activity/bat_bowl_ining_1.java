 ...
 */
public class bat_bowl_ining_1 extends Fragment {
    public bat_inig1_Adapter bat_inig1_adapter;
    public bowl_ining1_Adapter bowl_ining1_adapter;
    ...
    public String player_id, player_fName, player_name;

    public bat_bowl_ining_1() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bat_inig1_adapter = new bat_inig1_Adapter(this);
        bowl_ining1_adapter = new bowl_ining1_Adapter(this);
                ...
                try {
                    ...
                    if (match.has("Innings")) {
                        ...
                        if (Innings.has("1")) {
                            ...
                            if (Inning_num_1.has("batsmen")) {
                                if (match.has("players")) {
                                    JSONArray players = match.getJSONArray("players");
                                    JSONArray batsmen = Inning_num_1.getJSONArray("batsmen");
                                    ...
                                    if (Inning_num_1.has("bowlers")) {
                                        JSONArray bowlers = Inning_num_1.getJSONArray("bowlers");
                            ...
                            if (Inning_num_1.has("nextbatsman")) {
                                String nextbatsman = Inning_num_1.getString("nextbatsman");
                            }

                            if (Inning_num_1.has("extras")) {
                                JSONObject extras = Inning_num_1.getJSONObject("extras");
                            ...
                            if (Inning_num_1.has("fow")) {
                                JSONArray fow = Inning_num_1.getJSONArray("fow");
                    ...
                    if (match.has("team2")) {
                        ...
                        for (int k = 0; k < squad_team2.length(); k++) {
                            constants.value_squad_team2 = squad_team2.getString(k);
