...
public class bat_bowl_ining_3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bat_inig1_adapter = new bat_inig3_Adapter(this);
        bowl_ining1_adapter= new bowl_ining3_Adapter(this);
                ...
                try {
                    ...
                    if (match.has("Innings")) {
                        ...
                        if (Innings.has("3")) {
                            ...
                            if (Inning_num_3.has("batsmen")) {
                                if (match.has("players")) {
                                    JSONArray players = match.getJSONArray("players");
                                    JSONArray batsmen = Inning_num_3.getJSONArray("batsmen");
                                    ...
                                    if (Inning_num_3.has("bowlers")) {
                                        JSONArray bowlers = Inning_num_3.getJSONArray("bowlers");
                            ...
                            if (Inning_num_3.has("nextbatsman")) {
                                String nextbatsman = Inning_num_3.getString("nextbatsman");
                            }

                            if (Inning_num_3.has("extras")) {
                                JSONObject extras = Inning_num_3.getJSONObject("extras");
                            ...
                            if (Inning_num_3.has("fow")) {
                                JSONArray fow = Inning_num_3.getJSONArray("fow");
