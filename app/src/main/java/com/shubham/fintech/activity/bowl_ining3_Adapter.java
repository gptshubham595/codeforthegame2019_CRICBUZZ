...
public class bowl_ining3_Adapter extends BaseAdapter {
    bat_bowl_ining_3 main;

    bowl_ining3_Adapter(bat_bowl_ining_3 main) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        bowl_ining3_Adapter.ViewHolderItem holder = new bowl_ining3_Adapter.ViewHolderItem();
        if (convertView == null) {
            ...
            holder = (bowl_ining3_Adapter.ViewHolderItem) convertView.getTag();
        }
