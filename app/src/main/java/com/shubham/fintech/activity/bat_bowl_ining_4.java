 ...
 */
public class bat_bowl_ining_4 extends Fragment {
    public bat_inig4_Adapter bat_inig1_adapter;
    public bowl_ining4_Adapter bowl_ining1_adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bat_inig1_adapter = new bat_inig4_Adapter(this);
        bowl_ining1_adapter= new bowl_ining4_Adapter(this);
                ...
                try {
                    ...
                    if (match.has("Innings")) {
                        ...
                        if (Innings.has("4")) {
                            ...
                            if (Inning_num_4.has("batsmen")) {
                                if (match.has("players")) {
                                    JSONArray players = match.getJSONArray("players");
                                    JSONArray batsmen = Inning_num_4.getJSONArray("batsmen");
                                    ...
                                    if (Inning_num_4.has("bowlers")) {
                                        JSONArray bowlers = Inning_num_4.getJSONArray("bowlers");
                            ...
                            if (Inning_num_4.has("nextbatsman")) {
                                String nextbatsman = Inning_num_4.getString("nextbatsman");
                            }
                            if (Inning_num_4.has("extras")) {
                                JSONObject extras = Inning_num_4.getJSONObject("extras");
                            ...
                            if (Inning_num_4.has("fow")) {
                                JSONArray fow = Inning_num_4.getJSONArray("fow");
